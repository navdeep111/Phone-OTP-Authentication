...
const Verify = () => {
  ...
  const handleVerifyOTP = async () => {
    try {
      ...
      const response = await axios.post('/api/auth/signup/check-otp', {
      ...
      if (response.status === 200) {
        ...
        navigate('/success-signup', { state: { mobileNumber } });
      } else {
...
<div className='flex flex-col sm:max-w-[480px] mx-auto sm:p-8 sm:mt-16'>
