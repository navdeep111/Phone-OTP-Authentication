   ...
   return (
    <div className='flex flex-col justify-between h-full sm:-ml-[20px] sm:-mt-0 -mt-[100px]'>
      ...
      <div className='flex flex-col items-center '>
        ...
        <Link to='/success-login' className= 'text-center mt-[40px] sm:w-[416px] w-[350px] h-[44px] bg-blue-200 rounded-[8px] text-[14px] font-[600] font-Montserrat text-blue-600 pt-[12px]'>Continue</Link>
      </div>
    </div>
  )
}
